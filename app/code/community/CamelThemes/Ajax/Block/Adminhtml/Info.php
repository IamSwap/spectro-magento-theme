 ...
 * @Class        CamelThemes_Ajax_Block_Adminhtml_Info 
 */

class CamelThemes_Ajax_Block_Adminhtml_Info extends Mage_Adminhtml_Block_System_Config_Form_Fieldset {
    ...
    public function render(Varien_Data_Form_Element_Abstract $element) {
        $content = '<h3>' . $this->__('Ajax documentation').'</h3>';
