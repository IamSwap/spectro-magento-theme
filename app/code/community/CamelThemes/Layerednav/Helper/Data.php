 ...
 * @Class        CamelThemes_Layerednav_Helper_Data  
 */
class CamelThemes_Layerednav_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function wrapProducts($html) {
        ...
        $loaderHtml = '<div class="camel_loading_filters" style="display:none"><img id="loading-image" src="' . Mage::getDesign()->getSkinUrl('images/layerednav/ajax-loader.gif') . '" /></div>';
        $html .= $loaderHtml;
        ...
        if (Mage::app()->getRequest()->isXmlHttpRequest()) {
            ...
            $html = '<div id="camel_layered_container">'
                    . $html
                    . '</div>'
                    . '';
        }
