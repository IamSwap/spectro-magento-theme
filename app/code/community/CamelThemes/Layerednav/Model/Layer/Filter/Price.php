...
* @Class        CamelThemes_Layerednav_Model_Layer_Filter_Price   
*/ 

    class CamelThemes_Layerednav_Model_Layer_Filter_Price extends Mage_Catalog_Model_Layer_Filter_Price
    {
