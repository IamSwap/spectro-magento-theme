 ...
 * @Class        CamelThemes_ThemeOptions_Block_Adminhtml_System_Config_Form_Field_Font
 */ 

class CamelThemes_ThemeOptions_Block_Adminhtml_System_Config_Form_Field_Font extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="'.$element->getHtmlId().'_preview" style="font-size:20px; margin-top:5px;">The quick brown fox jumps over the lazy dog</div>
		<script>
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
                ...
                this.previewElement = $("'.$element->getHtmlId().'_preview");
                this.loadedFonts = "";
